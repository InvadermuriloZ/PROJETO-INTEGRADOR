       ...
       <div class="container text-center">
          ...
          ?>
            ...
            <img src="<?php echo $exibe['foto']?>" class="foto">
              ...
              <div class="col-3">
              <a href="visualizarImovel.php?local=<?php echo $local; ?>"><button type ="button" class="btn btn-success btn-sm">Visualizar</button></a>
              <a href="editarImovel.php?local=<?php echo  $local; ?>"><button type="button" class="btn btn-primary btn-sm">Editar</button></a>
              <a href="excluirImovel.php?local=<?php echo $local; ?>" onclick = "return confirm('Confirma a Exclusão do Imovel?')">
